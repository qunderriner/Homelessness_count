...
zillow_data = "Metro_Zhvi_AllHomes.csv"
city_csa_mapping = "Top Metros __ CoCs 2017 - CSA-MSA_augmented.csv"
...
def process_data(zillow_data, year,data_type,quarterly=False):
    ...
    if the data, like those in the "More Metrics" section of zillow, is reportedly quarterly. 
    """
